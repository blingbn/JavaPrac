...
/*
	...
	*/
		...
		*/
		...
		/*
		// split함수 : 문자열에서 특정문자를 기준으로 나누는 작업
		...
		*/
		...
		boolean result2 = aaa.equalsIgnoreCase(aaa2); // 대소문자 상관없이 비교 true
		...
		*/
		...
		/*
		//startsWith("문자열") : 지정문자열로 시작하는지 여부 boolean
