...
public class Ex05_13_1 {
	 ...
	 public static  Book   createBook() {//main전에 생성
	...
	public static void main(String[] args) {
		Book b1= createBook();//("데이터베이스", "홍길동", 100);
		System.out.println(b1.getInfo());
		Book b2= createBook();//("데이터베이스", "홍길동", 100);
...
//		System.out.println(book);
		...
		changeBook(book);
		System.out.println("변경후 ======"+ book.getInfo()); //참조형으로 바뀐 값 출력
